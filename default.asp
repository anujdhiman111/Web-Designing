...
<h2>Font Awesome 5 Icons</h2>
<p>To use the Free Font Awesome 5 icons, go to <a href="https://fontawesome.com">
fontawesome.com</a> and sign in to get a code to use in your web pages.</p>
<p>Read more about how to get started with Font Awesome in our
<a href="fontawesome5_intro.asp">Font Awesome 5</a> chapter.</p>
<p><strong>Note:</strong> No downloading or installation is required!</p>
<div class="w3-example">
<h3>Example</h3>
 <div class="w3-code notranslate htmlHigh">
  &lt;!DOCTYPE html&gt;<br>&lt;html&gt;<br>&lt;head&gt;<br>
     &lt;script src="https://kit.fontawesome.com/<em>yourcode</em>.js"&gt;&lt;/script&gt;<br>
   &lt;!--Get your code at fontawesome.com--&gt;<br>&lt;/head&gt;<br>&lt;body&gt;<br><br>&lt;i class="fas fa-band-aid"&gt;&lt;/i&gt;<br>&lt;i 
   class="fas fa-cat"&gt;&lt;/i&gt;<br>&lt;i class="fas fa-dragon"&gt;&lt;/i&gt;<br>&lt;i class="far fa-clock"&gt;&lt;/i&gt;<br>
   &lt;i class="fas fa-clock"&gt;&lt;/i&gt;<br><br>
  &lt;/body&gt;<br>&lt;/html&gt;
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryicons_awesome5" target="_blank">Try It Yourself &raquo;</a>
</div>
<hr>

<h2>Font Awesome 4 Icons</h2>
<p>To use the Font Awesome 4 icons, add the following line inside the <code class="w3-codespan">&lt;head&gt;</code> section of your HTML page:</p>
<p><strong>Note:</strong> No downloading or installation is required!</p>
<div class="w3-example">
<h3>Example</h3>
 <div class="w3-code notranslate htmlHigh">
...
<p>To use the Bootstrap 3 glyphicons, add the following line inside the <code class="w3-codespan">&lt;head&gt;</code> section of your HTML page:</p>
<p><strong>Note:</strong> No downloading or installation is required!</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
...
<p><strong>Note:</strong> Glyphicons are not supported in Bootstrap 4.</p>
<p>For more information about Bootstrap 3 and Glyphicons, visit our <a href="/bootstrap/default.asp">Bootstrap 3 Tutorial.</a></p>
